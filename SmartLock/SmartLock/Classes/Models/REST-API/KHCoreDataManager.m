...
#import "KHCoreDataManager.h"

@interface KHCoreDataManager ()
...
@implementation KHCoreDataManager

#pragma mark - Singleton

+ (KHCoreDataManager *)sharedManager
{
	static KHCoreDataManager *sharedManager = nil;

	static dispatch_once_t onceToken;

	dispatch_once(&onceToken, ^{
					  sharedManager = [KHCoreDataManager new];
				  });
...
- (void)save
{
	...
	if (self.managedObjectContext != nil) {
		...
		if ([self.managedObjectContext hasChanges] && ![self.managedObjectContext save:&error]) {
			NSLog(@"\n\n\n======================================================================\n");
			NSLog(@"PLEASE REPORT TO @PASCAL! [SAVING MANAGED OBJECT CONTEXT WENT WRONG]");
...
- (NSManagedObjectModel *)managedObjectModel
{
	...
	NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"KneeHapp" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
	...
	NSURL *storeURL = [[self applicationDocumentsDirectory]
					   URLByAppendingPathComponent:@"KneeHapp.sqlite"];
