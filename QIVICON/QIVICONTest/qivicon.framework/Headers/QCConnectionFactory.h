 ...
 */
@property (nonatomic) id <QCGlobalSettingsProvider> globalSettingsProvider;
 ...
 * It is not verified, if the IP address is correct and reachable!
 * <p>
 * The connection returned is already authorized. If authorization fails, an
 ...
 * @deprecated will be removed once <i>Service Gateways</i> use HTTPS only
 */
- (QCLocalServiceGatewayConnection*) localGatewayConnectionWithAddress:(NSString*)address
