...
- (id)initWithConnectionContext:(id <QCHTTPConnectionContext>)connectionContext webSocketConnectionFactory:(QCWebSocketConnectionFactory*)wsFactory connection:(QCServiceGatewayConnection*)connection websocketURL:(NSString*)websocketURL pushMethod:(PushMethod)pushMethod;
